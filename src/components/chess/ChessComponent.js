    ...
    handleClick(i) {
        ...
        if (this.state.sourceSelection === -1) {
            if (!squares[i] || squares[i].player !== this.state.player) {
                ...
                squares[i].style = { ...squares[i].style, backgroundColor: "RGBA(111,143,114)" }; // Emerald from http://omgchess.blogspot.com/2015/09/chess-board-color-schemes.html
                this.setState({
            ...
            <div>
                <div className="game">
                    <div className="row">
                        ...
                        <div className="col-lg game-info">
                            <h3>Turn</h3>
